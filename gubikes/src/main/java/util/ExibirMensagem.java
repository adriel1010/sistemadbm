...
public class ExibirMensagem {
	...
	public static void exibirMessageWarn(String mensagem){
		FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_WARN, "", "sdsdsdsdsd"));
		}
}
